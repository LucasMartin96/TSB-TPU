...
public class TSBHastableDA<K, V> implements Map<K, V>, Cloneable, Serializable {
    ...
    public TSBHastableDA() {
        this(53, 0.75f);
    }


    public TSBHastableDA(int initial_capacity) {
        this(initial_capacity, 0.75f);
    }


    public TSBHastableDA(int initial_capacity, float load_factor) {
        if (load_factor <= 0) {
            load_factor = 0.75f;
        }
        if (initial_capacity <= 0) {
            ...
            if (initial_capacity > TSBHastableDA.MAX_SIZE) {
                initial_capacity = TSBHastableDA.MAX_SIZE;
            } else {
    ...
    public TSBHastableDA(Map<? extends K, ? extends V> t) {
        this(53, 0.75f);
        this.putAll(t);
    }
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        @Override
        public int size() {
            return TSBHastableDA.this.count;
        }

        @Override
        public boolean contains(Object o) {
            return TSBHastableDA.this.containsKey(o);
        }

        @Override
        public boolean remove(Object o) {
            return (TSBHastableDA.this.remove(o) != null);
        }

        @Override
        public void clear() {
            TSBHastableDA.this.clear();
        }
        ...
        private class KeySetIterator implements Iterator<K> {
            ...
            public KeySetIterator() {
                ...
                current_entry = -1;
                next_ok = false;
                expected_modCount = TSBHastableDA.this.modCount;
            }


            @Override
            public boolean hasNext() {
                Entry<K, V> t[] = TSBHastableDA.this.table;
                int s[] = TSBHastableDA.this.states;
            ...
            public K next() {
                ...
                if (TSBHastableDA.this.modCount != expected_modCount) {
            ...
            public void remove() {
                ...
                TSBHastableDA.this.table[current_entry] = null;
                TSBHastableDA.this.states[current_entry] = 2;
                current_entry = last_entry;
                next_ok = false;
                TSBHastableDA.this.count--;
                TSBHastableDA.this.modCount++;
                expected_modCount++;
            }
        }
    }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            ...
            int ih = TSBHastableDA.this.h(entry.getKey());
            int ic = ih;
            int j = 1;
    ...
    private class ValueCollection extends AbstractCollection<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return TSBHastableDA.this.containsValue(o);
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        TSBHastableDA<K, V> t = new TSBHastableDA<>(this.table.length, this.load_factor);
    ...
    protected void rehash() {
        ...
        if (new_length > TSBHastableDA.MAX_SIZE)
            new_length = TSBHastableDA.MAX_SIZE;
